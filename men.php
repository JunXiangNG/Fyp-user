...
<?php
$select_query = "SELECT * FROM product INNER JOIN product_details ON product.product_id = product_details.product_id WHERE product_gender='men' and  product_status = 'A'" ;
