...
if (isset($_SESSION['username'])) {
    ...
    if (isset($_GET['order_id'])) {
        ...
        $select_query = "SELECT orders.*, orders.order_status, orders.product_price, orders.user_quantity,checkout.order_timestamp, checkout.received_name, checkout.address, checkout.phone ,checkout.town_city,checkout.zip_postalcode,checkout.state_province
        FROM orders
