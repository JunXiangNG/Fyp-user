...
if (isset($_GET['product_id'])) {
    ...
    $select_query = "SELECT * FROM product
                     ...
                     WHERE product.product_id = $product_id and product_gender ='women'";
    ...
    if ($result_query) {
	  ...
	  $product_color = $row['product_color'];
        ...
        $color_query = "SELECT DISTINCT product_color FROM product_details WHERE product_id = $product_id AND product_gender='women'";
        $size_query = "SELECT DISTINCT product_size FROM product_details WHERE product_id = $product_id AND product_gender='women'";
		$image_query = "SELECT DISTINCT product_image FROM product_details WHERE product_id = $product_id AND product_gender='women'";
...
if (isset($_POST['savebtn'])) {
    ...
    $query = "SELECT p.product_name, pd.product_price, pd.product_quantity
              ...
              WHERE pd.product_id = '$product_id' AND product_gender='women' AND p.product_status = 'A'";
            ...
            if (mysqli_num_rows($check_result) > 0) {
                ...
                if ($new_quantity <= 5) {
                    ...
                    if ($update_result2) {
                        ...
                        echo '<script>window.location.href = "http://localhost/fyp/women_product_details.php?product_id=' . $product_id . '";</script>';
                    } else {
